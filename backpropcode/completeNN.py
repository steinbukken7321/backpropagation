...
# Adding a function to get the outputs of the neural network before training
def get_output_before_training(self, inputs):
    hidden_layer_outputs = self.hidden_layer.feed_forward(inputs)
    return self.output_layer.feed_forward(hidden_layer_outputs)

# Adding the function to the NeuralNetwork class
...
print("Output of o1 before training:", o1)
print("Output of o2 before training:", o2)
